...
class LTAssistant {
    constructor(e) {
        ...
        const t = this._behaviorTweaks.supported(),
            n = this._behaviorTweaks.unsupportedMessage();
    ...
    _initInstance(e, t = !0) {
        e.parentElement && (this._instances.some(t => t.targetElement === e) || this._getDomainState().isDisabled || this._behaviorTweaks.isElementCompatible(e) && (this._disableOtherSpellCheckers(e), clearTimeout(this._initTimeout), this._initTimeout = window.setTimeout(() => {
            ...
            this._instances.push(a), this.updateState(a), this._validateInstance(a), onElementDisabled(e, () => this._destroyInstance(a)), onElementRemoved(e, () => this._destroyInstance(a))
        }, 150)))
    }
    _validateInstance(e, t, n, r = !1) {
        ...
        if (!i && !this._storageController.isUsedCustomServer() && t.length > config.MAX_TEXT_LENGTH) return e.isValidating = !1, e.isTextTooLong = !0, e.allErrors = [], e.allHiddenErrors = [], this._setDisplayedErrors(e, e.allErrors), this._setHiddenErrors(e, e.allHiddenErrors), this._leaveTypingMode(e), this._highlight(e), this.updateState(e), void(e.validatedText = "");
        e.isValidating = !0, e.lastValidation = Date.now(), e.isSupportedLanguage || (e.isSupportedLanguage = !0, e.forceLanguage || (e.language = null)), this.updateState(e), !e.forceLanguage && n.isAllTextChanged && (e.language = null), this._behaviorTweaks.getRecipientInfo(e.targetElement).then(i => {
            const s = {
                    instanceId: e.id,
                    url: getCurrentUrl(),
                    recipientInfo: i
            ...
            browser.runtime.sendMessage(o).then(e => {
                ...
                e.isValidating = !1, Tracker.trackError("message", t.message, o.command), (t.message && t.message.startsWith("Invocation of form runtime.connect(null, ) doesn't match definition runtime.connect") || t.message.startsWith("Extension context invalidated.")) && this._instances.forEach(e => {
    ...
    _onTextChanged(e) {
        const t = e.detail.inputAreaWrapper,
            n = this._instances.find(e => e.inputAreaWrapper === t);
        if (!n) return;
        if (!n.isConnected || !n.isRemoteCheckAllowed || !n.isAutoCheckEnabled) return;
        this._hideAllErrorCards(), this._enterTypingMode(n);
        const r = e.detail.text;
        if (n.exception = null, r.trim().length < config.MIN_TEXT_LENGTH) n.language = n.forceLanguage ? n.language : null, n.isValidating = !1, n.isTextTooLong = !1, n.allErrors = [], n.allHiddenErrors = [], this._setDisplayedErrors(n, n.allErrors), this._setHiddenErrors(n, n.allHiddenErrors), this._leaveTypingMode(n), this._highlight(n), this.updateState(n), n.validatedText = r, this._validateInstanceDebounce.cancelCall();
        else if (r === n.validatedText) n.isValidating = !1, this._setDisplayedErrors(n, n.allErrors), this._setHiddenErrors(n, n.allHiddenErrors), this._highlight(n), this.updateState(n), this._validateInstanceDebounce.cancelCall();
        else {
            const e = LTAssistant._getTextChanges(n.validatedText, r, n.allErrors);
            n.isValidating = !0, n.isTextTooLong = !1, this._setDisplayedErrors(n, e.nonAffectedErrors), this._setHiddenErrors(n, n.allHiddenErrors), this._highlight(n), this.updateState(n), Date.now() - n.lastValidation > config.INTERMEDIATE_VALIDATION_INTERVAL ? (this._validateInstanceDebounce.cancelCall(), this._validateInstance(n, r, e)) : this._validateInstanceDebounce.call(n, r, e)
        }
    }
    _enterTypingMode(e) {
    ...
    _onValidationFailed(e) {
        const t = this._instances.find(t => t.id === e.instanceId);
        if (t) {
            if (t.isValidating = !1, t.isIncompleteResult = !1, t.exception = e.exception, t.validatedText = "", t.allErrors = [], t.displayedErrors = [], t.pendingErrors = [], t.allHiddenErrors = [], t.displayedHiddenErrors = [], t.pendingHiddenErrors = [], e && e.exception && void 0 !== e.exception.status) this._storageController.isUsedCustomServer() || Tracker.trackError("http", `${e.exception.status}: ${e.exception.response}`);
